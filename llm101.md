...
- [How LLMs differ from traditional ML](#how-llms-differ-from-traditional-ml)
- [Enterprise value proposition](#enterprise-value-proposition)
- [Core concepts](#core-concepts)
- [Reasoning models — the biggest shift since GPT-4](#reasoning-models--the-biggest-shift-since-gpt-4)
- [Tool use and the agent loop](#tool-use-and-the-agent-loop)
- [MCP — the tool-integration standard](#mcp--the-tool-integration-standard)
- [RAG — retrieval-augmented generation](#rag--retrieval-augmented-generation)
- [Fine-tuning — when to reach for it](#fine-tuning--when-to-reach-for-it)
- [Deployment options](#deployment-options)
- [LLM API — the shape worth knowing](#llm-api--the-shape-worth-knowing)
- [Important LLMs (Jan 2026 snapshot)](#important-llms-jan-2026-snapshot)
- [LLMs and Salesforce mental model](#llms-and-salesforce-mental-model)
- [Gotchas worth knowing early](#gotchas-worth-knowing-early)
- [Calling the API from Python (Anthropic SDK)](#calling-the-api-from-python-anthropic-sdk)
